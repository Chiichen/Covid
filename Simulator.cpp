...
LocalArea::LocalArea(short x0, short y0, bool b)
{
	...
	this->Natural_Growth_Daily = this->Population * this->Natural_Growth_Rate / 365;//地区每日自然增长人口初始化	
	this->Infectious_Rate = 0.01;//地区病毒传播率初始化
	this->Fund = u3(e);//地区总资产初始化 1000 - 2000
	this->Income_Rate_Daily = 0.00001 * u3(e);//地区每日收益率初始化 0.01 - 0.02
	this->Income_Daily = Fund * Income_Rate_Daily;//地区每日收益初始化 10 - 20 
	...
	this->Recovered_Rate = 0.1 * (u4(e) * 2 - 1);//地区康复率初始化
